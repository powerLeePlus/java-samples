...
/**
 * 六、受保护的资源（Protected Resource）（对应父工程README.md的流程图）
 * @author lwq
 * @date 2020/7/16 0016
 * 1、首先通过如http://localhost:8081/oauth-org.lwq.oauth2.server/userInfo?access_token=828beda907066d058584f37bcfd597b6进行访问；
...
public class UserInfoController {
	...
	public HttpEntity userInfo(HttpServletRequest request) throws OAuthSystemException {
		...
		/**
		 * 请求示例：http://localhost:8081/oauth-server/userInfo?access_token=828beda907066d058584f37bcfd597b6
		 *
		 * 请求需要的参数
		 * 1、access_token  // 访问资源的授权令牌
		 * */
