package org.lwq.oauth2.server.config;
...
import org.lwq.oauth2.server.realm.CustomerRealm;
...
public class ShiroConfig {
	...
	public ShiroFilterFactoryBean shiroFilterFactoryBean(SecurityManager securityManager) {
		...
		map.put("/oauth-server/authorize", "anon");
		map.put("/oauth-server/accessToken", "anon");
		map.put("/oauth2.jsp", "anon");
		map.put("/oauth2", "anon");

		map.put("/oauth-server/userInfo", "anon");
